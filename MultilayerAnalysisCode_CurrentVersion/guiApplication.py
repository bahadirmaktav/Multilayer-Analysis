...
def InitializeValues():
    ...
    wavelengthRangeHighEntry.insert(0,"1600")
    stepSizeEntry.insert(0,"0.1")
    refraciveIndexEntries[0].insert(0,"4.234")
    refraciveIndexEntries[1].insert(0,"1.45")
    refraciveIndexEntries[2].insert(0,"2.30")
    refraciveIndexEntries[3].insert(0,"1.45")
    refraciveIndexEntries[4].insert(0,"1")
    refraciveIndexEntries[5].insert(0,"1")
    refraciveIndexEntries[6].insert(0,"1.000273")
    refraciveIndexEntries[7].insert(0,"1.000273")
    thicknessEntries[3].insert(0,"250")
...
ws.geometry('850x400')
#ws.iconbitmap("C:/Users/Bahadir/Desktop/BahadirUni/ELE401GraduationProject_I/Codes/MultilayerAnalysis_GraduationProject/MultilayerAnalysisCode_CurrentVersion/multilayerAnalysisIcon2.ico")
