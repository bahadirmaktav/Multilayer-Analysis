...
import multilayerAnalysis as ma
...
def Analyze():
    try:
        ...
        wavelengthRange = arange(float(wavelengthRangeLowStr.get()),float(wavelengthRangeHighStr.get()),stepSize)
        ma.MultilayerAnalysis(designWaveLength=designWavelength,
...
ws.geometry('750x400')
ws.iconbitmap("C:/Users/Bahadir/Desktop/BahadırUni/ELE401GraduationProject_I/Codes/MultilayerAnalysis_GraduationProject/MultilayerAnalysisExecutable/multilayerAnalysisIcon2.ico")
